        ...
        <div class="block">  
			...
			?>
				<tr class="odd gradeX">
					...
					?></td>
					<td><a href="payedit.php?payid=<?php echo $result['MA_MA'] ?>">Edit</a> || 
					<a onclick =  "return confirm ('Bạn có chắc muốn xóa không???')" href="?payid=<?php echo $result['MA_MA'] ?>">Delete</a></td>
				</tr>
			<?php
				}
			}
