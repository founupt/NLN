...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th3 20, 2024 lúc 10:40 PM
...
--
ALTER TABLE `bao_gom`
  MODIFY `BG_MA` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=43;
...
--
ALTER TABLE `hoadon`
  MODIFY `HD_MA` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1555037814;
