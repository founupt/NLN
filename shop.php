...
?>
      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
            ...
            <h1 class="mb-0 bread"><span class="mr-2"><a href="index.php">Home |</a></span>Món ăn</h1>
          </div>
        </div>
      </div>
    </div>
    ...
    <section class="ftco-section">
    	...
    	<div class="row">
		<?php
						$product_show = $product -> getproduct_new();
						if($product_show){
    		...
    		<div class="col-md-6 col-lg-3 ftco-animate">
    				...
    				<div class="product">
    					...
    					<a href="#" class="img-prod"><img class="img-fluid" src="../food/images/<?php echo $result['MA_HINHANH']?>" alt="Colorlib Template">
