...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th3 10, 2024 lúc 09:17 AM
...
CREATE TABLE `giohang` (
  `GH_MA` int(11) NOT NULL,
  `GH_SL` int(20) NOT NULL,
  `MA_MA` int(11) NOT NULL,
  `GH_MASS` varchar(30) NOT NULL,
  `MA_TEN` varchar(30) NOT NULL,
  `MA_GIA` float NOT NULL,
  `MA_HINHANH` varchar(100) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `giohang` (`GH_MA`, `GH_SL`, `MA_MA`, `GH_MASS`, `MA_TEN`, `MA_GIA`, `MA_HINHANH`) VALUES
(79, 1, 10, 'fluv7j959cvfm7gm0v7ihveacs', 'Chè cô Chu', 27000, 'product-10.jpg'),
(81, 1, 11, 'fluv7j959cvfm7gm0v7ihveacs', 'Sabu Sabu', 120000, 'product-11.jpg'),
(82, 1, 12, '923k47lfmjcmbnn6t0biqce6gl', 'Highland', 65000, 'product-12.jpg'),
(83, 1, 11, 'ps85668jshj69k2tqqp6v379ke', 'Sabu Sabu', 120000, 'product-11.jpg'),
(85, 1, 8, 'ps85668jshj69k2tqqp6v379ke', 'Pizza Hut', 99000, 'product-8.jpg'),
(86, 2, 12, 'ps85668jshj69k2tqqp6v379ke', 'Highland', 65000, 'product-12.jpg');
...
INSERT INTO `hoadon` (`HD_MA`, `KH_MA`, `MA_MA`, `MA_TEN`, `MA_GIA`, `GH_SL`) VALUES
(7, 2, 11, 'Sabu Sabu', 120000, 1),
(8, 2, 11, 'Sabu Sabu', 120000, 1),
(9, 2, 8, 'Pizza Hut', 99000, 1),
(10, 2, 11, 'Sabu Sabu', 120000, 1),
(11, 2, 8, 'Pizza Hut', 99000, 1);
...
--
ALTER TABLE `chitietgiohang`
  MODIFY `GH_MA` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `giohang`
  MODIFY `GH_MA` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=87;

--
-- AUTO_INCREMENT cho bảng `hoadon`
--
ALTER TABLE `hoadon`
  MODIFY `HD_MA` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
...
--
ALTER TABLE `hoadon`
  ADD CONSTRAINT `hoadon_ibfk_3` FOREIGN KEY (`MA_MA`) REFERENCES `giohang` (`MA_MA`),
